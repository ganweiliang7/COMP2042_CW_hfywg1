...
import instructionmenu.InstructionMenu;
...
public class GameFrame extends JFrame implements WindowFocusListener {
    ...
    public GameFrame(){
        ...
        homeMenu = new HomeMenu(this,new Dimension(500,450));// change the home menu dimension
    ...
    public  void backToHomeMenu(GameBoard gameBoard)
    {
    ...
    public void enableInstructionMenu()
    {
        this.remove(homeMenu);
        this.repaint();
        instructionmenu.showinstructions(this);
